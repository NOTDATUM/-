...
function TeamDashboard({ snapshot, refresh, onLogout }: { snapshot: Snapshot; refresh: () => Promise<void>; onLogout: () => void }) {
  ...
  useEffect(() => { setQuantity((value) => clampOrderQuantity(value, maxOrderQuantity)); }, [maxOrderQuantity]);
